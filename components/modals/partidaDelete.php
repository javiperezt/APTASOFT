<!---------- MODAL ---------->
<div class="modal fade" id="partidaDelete" tabindex="-1" aria-labelledby="partidaDelete" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content p-4">
            ...
            <button onclick="partidaDelete(<?= $id_partida; ?>)" class="btn btn-danger w-100 mt-3">Eliminar</button>
        </div>
    </div>
</div>
<!---------- END MODAL ---------->