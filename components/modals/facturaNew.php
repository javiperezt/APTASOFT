<!---------- MODAL ---------->
<div class="modal fade" id="facturaNew" tabindex="-1" aria-labelledby="facturaNew" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content p-4">
            <button type="button" class="btn-close position-absolute" style="top: 10px;right: 10px"
                    data-bs-dismiss="modal" aria-label="Close"></button>
            <form action="../backend/facturas/facturaCreate.php" method="POST" autocomplete="off">
                <p class="text-black fs-4 fw-bold mb-3">Nueva factura</p>
                <div class="row" style="row-gap: 10px">
                    <div class="col-6">
                        <div class="form-floating">
                            <input id="ref" required type="text" class="form-control" placeholder="Referencia"
                                   name="ref"
                                   value="<?= $nextRefInvoice; ?>">
