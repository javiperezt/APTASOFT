...
$query = $mysqli->query("SELECT * FROM gastos where is_active=1 and fecha_inicio BETWEEN '$fecha_inicio' and '$fecha_fin'");

if ($query->num_rows >= 0) {

    $delimiter = ",";
    $filename = "gastos" . date('Y_m_d') . ".xls";
    ...
    while ($row = $query->fetch_assoc()) {
        ...
        $lineData = array($fecha_inicio, $fecha_vencimiento, $nombre_contacto, $titulo_obra, $subtotal, $total, $estado);
